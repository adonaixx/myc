 ...
 *
 * @template This The type of the `this` context in which the function is
 *   invoked.
 */
type Trigger<This = void> = (this: This) => void;

/**
 * A function that consumes a single argument of a given {@link Type `Type`}.
 *
 * @template This The type of the `this` context in which the function is
 *   invoked.
 */
...
/**
 * A function that consumes multiple arguments of a given {@link Type `Type`}.
 *
 * @template This The type of the `this` context in which the function is
 *   invoked.
 */
...
/**
 * A function that supplies a value of a given {@link Type `Type`}.
 *
 * @template This The type of the `this` context in which the function is
 *   invoked.
 */
...
/**
 * A function that transforms an argument of one type ({@link Type `Type`}) into
 * a value of another type ({@link Target `Target`}).
 *
